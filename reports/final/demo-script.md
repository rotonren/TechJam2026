...
selected development CV mean `0.662377`, selection score `0.644160`, and the
optimized public score `0.660605` (HitRate@10 `0.840`, MRR `0.376349`, MTTC
`4.615`). State zero fallbacks across the four selection folds, zero runtime API
cost, and the deterministic package SHA256 printed by the release command. Do
not describe historical fold 5 as a blind audit for the optimized candidate.
